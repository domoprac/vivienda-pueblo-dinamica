# DAFO — Santacara (Navarra)

Instancia concreta del [DAFO_TEMPLATE.md](DAFO_TEMPLATE.md) con datos reales del municipio piloto.

**Municipio**: Santacara · Navarra · Comarca Ribera Arga-Aragón
**Población**: 858 hab. (padrón 2024) · Tendencia: descendente (-5 en 2023-2024)
**Fecha de diagnóstico**: 2025

---

## Fortalezas (interno · positivo)

### Demografía y base social
- 51% de residentes nacidos fuera del municipio → capacidad de atracción demostrada históricamente
- Masa crítica suficiente (858 hab.) para mantener servicios básicos activos
- Cooperativa agrícola San Isidro activa desde 1958 → tejido económico local consolidado

### Finanzas municipales — diferencial clave
...
- Índice de calidad de vida relativa alto para su tamaño
  → Ver comparativa en [mapa-calidad-vida](https://github.com/domoprac/mapa-calidad-vida)
...
### Demografía
- Crecimiento vegetativo negativo: 9 defunciones más que nacimientos (2023)
- Pérdida neta de 5 habitantes en el último año
...
### Vivienda
- Stock de viviendas vacías y ruinas sin cuantificar ni gestionar activamente
- Ausencia de oferta de vivienda de alquiler asequible para atraer nueva población
- Tasa de paro local (10,8%) ligeramente por encima de la media navarra
...
- Diferencial coste ciudad/pueblo cada vez mayor → incentivo real y cuantificable
...
- Multiplicador local: obra → proveedores locales → empleo → comercio → servicios → población
...
- Sin estrategia de marketing territorial activa

---

## Lectura estratégica

Santacara tiene un perfil **F > D, O > A**: fortalezas internas sólidas y entorno con oportunidades reales.
...
4. Lanzar el modelo de economía circular: rehabilitación → venta/alquiler → reinversión

---

*Herramienta genérica: [DAFO_TEMPLATE.md](DAFO_TEMPLATE.md)*
*Siguiente paso: [ISHIKAWA.md](ISHIKAWA.md)*
